...
uv run python run_pipeline.py --output ../outputs/ --max-trials -1 --max-candidates 999999 --sample-seed 42 --drugbank-csv ../drugbank_approvals_smiles.csv --all-modalities --chembl-snapshot ../chembl_targets.sqlite  --opentargets-snapshot ../opentargets_snapshot.sqlite --year-range 2009-2026 --no-drop-uncached-candidates --require-smiles --use-ct-cache "$@"
